...
def choose(player1):
    ...
    if player1[1].dice == player1[3].dice + 1 and player1[3].dice == player1[4].dice + 1:
        ...
        round1 = 1
        rate1 = 2
    if player1[0].dice == player1[1].dice + 1 and player1[1].dice == player1[2].dice + 1 and player1[2].dice == \
            player1[3].dice + 1:
        for i in range(0, 5):
            player1[i].flag = 0
        player1[0].flag = 1
        ...
        round1 = 5
        rate1 = 2
    if player1[1].dice == player1[2].dice + 1 and player1[2].dice == player1[3].dice + 1 and player1[3].dice == \
            player1[4].dice + 1:
        for i in range(0, 5):
            player1[i].flag = 0
        player1[1].flag = 1
        ...
        round1 = 5
        rate1 = 2
    if player1[0].dice == player1[1].dice + 1 and player1[1].dice == player1[3].dice + 1 and player1[3].dice == \
            player1[4].dice + 1:
        for i in range(0, 5):
            player1[i].flag = 0
        player1[0].flag = 1
        ...
        rate1 = 2
    if player1[0].dice == player1[1].dice + 1 and player1[1].dice == player1[2].dice + 1 and player1[2].dice == \
            player1[3].dice + 1 and player1[3].dice == player1[4].dice + 1:
        for i in range(0, 5):
            player1[i].flag = 0
        player1[0].flag = 1
        player1[1].flag = 1
    ...
    if player1[2].dice == player1[3].dice and player1[3].dice == player1[4].dice:
        ...
        round1 = 2
        rate1 = 2
    if player1[0].dice == player1[1].dice and player1[1].dice == player1[2].dice and player1[2].dice == player1[
        3].dice:
        for i in range(0, 5):
            player1[i].flag = 0
        player1[0].flag = 1
        ...
        round1 = 3
        rate1 = 2
    if player1[1].dice == player1[2].dice and player1[2].dice == player1[3].dice and player1[3].dice == player1[
        4].dice:
        for i in range(0, 5):
            player1[i].flag = 0
        player1[1].flag = 1
        ...
        rate1 = 2
    if player1[0].dice == player1[1].dice and player1[1].dice == player1[2].dice and player1[2].dice == player1[
        3].dice and player1[3].dice == player1[4].dice:
        for i in range(0, 5):
            player1[i].flag = 0
        player1[0].flag = 1
        player1[1].flag = 1
...
def play(rate):
    ...
    round1 = 0
    rate1 = 0
    dices_ai, rate1, cnt1 = choose(player1)
    rate += rate1
    ...
    if round1 == 0:
        ...
        for i in range(0, 2):
            if player11[i].dice == player11[i + 1].dice + 1 and player11[i + 1].dice == player11[i + 2].dice + 1 and \
                    player11[i + 2].dice == player11[i + 3].dice + 1:
                # for i in range(0, 5):
                #     player1[i].flag = 0
                player11[i].flag = 1
                player11[i + 1].flag = 1
        ...
        for i in range(0, 3):
            if player11[i].dice == player11[i + 1].dice and player11[i + 1].dice == player11[i + 2].dice and \
                    player11[i + 2].dice == player11[i + 3].dice:
                player11[i].flag = 1
                player11[i + 1].flag = 1
                player11[i + 2].flag = 1
                player11[i + 3].flag = 1
        ...
        if player11[0].dice == player11[1].dice and player11[1].dice == player11[2].dice and player11[2].dice == \
                player11[3].dice and player11[3].dice == player11[4].dice:
            player11[0].flag = 1
            player11[1].flag = 1
            player11[2].flag = 1
            player11[3].flag = 1
        ...
        if player11[0].dice == player11[1].dice + 1 and player11[1].dice == player11[2].dice + 1 and player11[
            2].dice == player11[3].dice + 1 and player11[3].dice == player11[4].dice + 1:
            player11[0].flag = 1
            player11[1].flag = 1
            player11[2].flag = 1
            player11[3].flag = 1
    ...
    return dices_ai, dices_player2, rate

def cal(dices_ai, dices_player2, rate, ai, player2, grade_ai, grade_player2):
    num_ai = [0, 0, 0, 0, 0, 0]
    for dice in dices_ai:
        if dice == 1:
            num_ai[0] += 1
    ...
    if player2 < 0:
        ...
        count = roll
    return score, grade_ai, grade_player2, ai, player2
...
if __name__ == '__main__':
    ...
    while count <= roll:
        ...
        dices_ai, dices_player2, rate = play(rate)
        score, grade_ai, grade_player2, ai, player2 = cal(dices_ai, dices_player2, rate, ai, player2, grade_ai,
                                                  grade_player2)
